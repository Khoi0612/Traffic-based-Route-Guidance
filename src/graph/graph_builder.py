...
def export_to_file(content, base_name):
...
def run_generator(origin, destination, ml_model_type, target_dt):  
    # Path to data file
    data_file = os.path.join('..', 'data', 'raw' , 'Scats Data October 2006.xls')
    ...
    edges = generate_edges(nodes, connections, 'models', ml_model_type.lower(), target_dt)
